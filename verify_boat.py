...
boat = Diagram(
    ...
    body=[
        ...
        Step(body=[
            ...
            ValleyFold("aad", "o"),
            SimpleArrow("ad", Edge("aad", "o"), ArrowHead.NONE, ArrowHead.VALLEY, ArrowSide.RIGHT),
            Assign("bbc", PointToLine("bc", "o", Edge("o", "ab"), Edge("b", "bc"), Which.SECOND)),
            ValleyFold("bbc", "o"),
            SimpleArrow("bc", Edge("bbc", "o"), ArrowHead.NONE, ArrowHead.VALLEY, ArrowSide.LEFT),
            Cut(Edge("ad", "bc"), "o"),
...
if __name__ == "__main__":
    print(write(boat))
    render_diagram(boat, OutputFormat.PDF, "simple_boat.pdf")
