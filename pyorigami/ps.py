...
def _write_prologue(out: StringIO) -> None:
    out.write(r"""/cm {72 mul 2.54 div} bind def
...
/draw_symbol { % x y s r string angle draw_symbol -
  ...
  /x exch def
  gsave
    r matrix rotate /M exch def
    r s width_height /H exch def /W exch def
    x y M transform /y1 exch def /x1 exch def
    0 setlinewidth
    [] 0 setdash
    r neg rotate
    ...
    tetha neg rotate
    tetha 270 ge tetha 360 lt and  {
      0 H neg moveto
    } {
      tetha 90 ge tetha 180 lt and  {
        W neg 0 moveto
      } {
...
/intersection { % v1x v1y v2x v2y e1x e1y e2x e2y intersection x y
  ...
  0 det ne {
    c1 b2 mul b1 c2 mul sub det div
...
""")
    out.write(f"""/make_first_page_header {{
  /r_margin exch def
  /l_margin exch def
  /comment3 exch def
  /comment2 exch def
...
""")
    out.write(r"""/push_arrow { % x y alpha distance angle scale push_arrow -
  /sc exch def
  /angle exch def
  /d exch def
  /alpha exch def
...
/repeat_arrow { % x y nb s alpha distance angle scale push_arrow -
  ...
  gsave
    ...
    s () ne {
      ...
      alpha 270 ge alpha 360 lt and  {
        0 H neg moveto
      } {
        alpha 90 ge alpha 180 lt and  {
          W neg 0 moveto
        } {
